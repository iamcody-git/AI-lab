...
jug1, jug2, aim = 3, 2, 1
visited = defaultdict(lambda: False) # creates a dictionary where all default values are False.
# If one of the jugs contains the exact target amount (aim) and the other is empty, print the solution
#and stop.
